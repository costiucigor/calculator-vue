<template>
  <div class="name-switcher">
    <div class="arrow left" @click="switchName(-1)"><svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="arrow right" @click="switchName(1)"><svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  data() {
    return {
      names: ['Комфорт Люмо', 'Комфорт Люмо2', 'Комфорт Люмо3'], // List of names
      descriptions: ['Улучшенные характеристики для более комфортного проживния', 'Улучшенные характеристики для более комфортного проживния2', 'Улучшенные характеристики для более комфортного проживния3'], // List of descriptions
      currentIndex: 0 // Initial index of the current name
    };
  },
  computed: {
    currentName() {
  ...
  methods: {
    switchName(direction) {
      this.currentIndex = (this.currentIndex + direction + this.names.length) % this.names.length;
    }
  }
};
</script>
